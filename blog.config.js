...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Levin', // 您的昵称 例如 tangly1024
  ...
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/levin8667', // 你的github个人主页 例如 https://github.com/tangly1024
